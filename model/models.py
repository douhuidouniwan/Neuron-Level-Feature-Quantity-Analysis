...
class CNN(nn.Module):
    def __init__(self):
        ...
        self.conv21 = nn.Conv2d(16, 16, kernel_size=3, padding=1, bias=False)
        self.relu21 = nn.ReLU(inplace=True)
        self.conv22 = nn.Conv2d(16, 16, kernel_size=3, padding=1, bias=False)
        ...
        self.conv41 = nn.Conv2d(32, 32, kernel_size=3, padding=1, bias=False)
        self.relu41 = nn.ReLU(inplace=True)
        self.conv42 = nn.Conv2d(32, 32, kernel_size=3, padding=1, bias=False)
...
class alexnet_no_pretrained(nn.Module):
    def __init__(self, out_planes, seed):
        super(alexnet_no_pretrained, self).__init__()
